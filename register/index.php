...
<body class="d-flex align-items-center py-4 bg-body-tertiary" data-bs-theme="dark">
    ...
    <main class="form-signin w-100 m-auto">
        <form>
            ...
            <div class="form-floating">
                <input type="surname" class="form-control" id="floatingInput" placeholder="surname">
            ...
            <div class="form-floating">
                ...
                <span class="text-danger" id="passwordError" style="display: none;">Please enter matching passwords.</span>
            </div>
